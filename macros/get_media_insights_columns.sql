...
{% set columns = [
    ...
    {"name": "carousel_album_shares", "datatype": dbt.type_int()},
    {"name": "carousel_album_views", "datatype": dbt.type_int()},
    ...
    {"name": "story_shares", "datatype": dbt.type_int()},
    {"name": "story_views", "datatype": dbt.type_int()},
    ...
    {"name": "video_photo_shares", "datatype": dbt.type_int()},
    {"name": "video_photo_views", "datatype": dbt.type_int()},
